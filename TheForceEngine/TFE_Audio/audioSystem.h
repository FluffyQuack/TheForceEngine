...
namespace TFE_Audio
{
	...
	SoundSource* createSoundSource(SoundType type, f32 volume, f32 stereoSeperation, const SoundBuffer* buffer, const Vec3f* pos = nullptr, bool copyPosition = false, SoundFinishedCallback callback = nullptr, void* userData = nullptr, void *playbackDelay = 0);
